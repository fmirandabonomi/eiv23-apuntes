...
Si bien es raro encontrar una máquina moderna que responda al modelo de Harvard estricto, la mayor parte de las máquinas modernas cuentan con buses separados de datos e instrucciones para poder cargar instrucciones y acceder a la memoria de datos en forma simultánea. En este caso la memoria de programa es accesible también desde el bus de datos. Estas microarquitecturas suelen denominarse Arquitecturas de Harvard Modificadas. [@null_lobur]
