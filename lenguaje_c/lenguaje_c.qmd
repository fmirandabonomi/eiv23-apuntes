...
Los literales compuestos crean **constantes** de tipo estructura, unión o arreglo. Para crearlos se especifica el tipo entre paréntesis y se ubica a continuación un inicializador con designación.
...
int main(void){
    ...
    assert(4 == i);
    // Puede tomarse la dirección de la constante
    // Esa dirección es de solo lectura.
    muestra_ficha(&(Ficha){
        .nombre = "Juan", // {'J','u','a','n',0,..,0}
        .apellido = "Perez",
        .edad = 20});
}
```
